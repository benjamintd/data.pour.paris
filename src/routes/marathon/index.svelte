...
<Info>
  ...
  <div slot="details">
    <p>
      ...
      coureurs en ordonnée, et la vitesse moyenne à chaque instant en couleur
      (du jaune, 8km/h, au violet, 18km/h). Les premiers coureurs qui terminent
      en moins de deux heures sont les marathoniens en fauteuil roulant.
    </p>
