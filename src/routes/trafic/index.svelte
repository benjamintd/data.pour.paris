...
<Info title="Trafic parisien" link="trafic">
  ...
  <div slot="details">
    <p>
      Jouez le trafic en appuyant sur
      <kbd class="kbd">play</kbd>
    ...
    <p>
      ...
      bouchon à l'arrêt, tandis qu'un trait épais et jaune pourrait correspondre
      à une situation de périphérique fluide.
    </p>
    <p>
      Certaines heures ne disposent pas de données pour quelques - ou l'ensemble
      - des routes. Pour cette raison le graphe de densité possède quelques
      creux dont il ne faut pas tenir compte.
    </p>
    <p>
    ...
    <p>
      Le mois de juin est intéressant car il comporte un jour férié - le lundi
      de pentecôte le 10 - et la fête de la musique le 21.
    </p>
  </div>
